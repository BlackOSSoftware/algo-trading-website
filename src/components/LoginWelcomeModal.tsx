...
const TRADING_QUOTE =
  "Emotionless trading is disciplined trading. Follow the plan, not the pulse.";
...
export default function LoginWelcomeModal({
  ...
  return (
    <div className="modal-overlay modal-overlay-top welcome-login-overlay" onClick={onClose}>
      <div
        className="welcome-login-card card"
        role="dialog"
        aria-modal="true"
      ...
      >
        <button
          className="icon-btn welcome-login-close"
          type="button"
          onClick={onClose}
        ...
        <div className="welcome-login-visual" aria-hidden="true">
          <div className="welcome-walker">
            <svg
              className="welcome-walker-leg-left"
              version="1.1"
            ...
            <svg
              className="welcome-walker-leg-right"
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
              width="41.02537"
              height="64.85502"
            ...
            <div className="welcome-walker-body">
              <svg
                version="1.1"
                xmlns="http://www.w3.org/2000/svg"
                width="144.10576"
            ...
            <svg
              className="welcome-walker-ground"
              version="1.1"
              xmlns="http://www.w3.org/2000/svg"
              width="475"
              height="530"
        ...
        <div className="welcome-login-copy">
          <div className="welcome-login-kicker">Session ready</div>
          <div className="page-title">Welcome back{name ? `, ${name}` : ""}</div>
          <div className="welcome-login-text">
            Your workspace is synced. Review signals, trust the setup, and execute with
            discipline.
          </div>
          <blockquote className="welcome-login-quote">{TRADING_QUOTE}</blockquote>
